let rmcCalendar = (function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // This should have ALL the possible views. Including ones that aren't selected by default on page load. This works with out select/deselect all buttons.
    let allPossibleViews = [
      "rmc-student-events",
      "rmc-alumni-events",
      "rmc-master-calendar",
      "rmc-athletics-jv-mens-basketball",
    ...
    let sourceButtonsIDs = [
      "rmc-master-calendar-button",
      "rmc-student-events-button",
      "rmc-alumni-events-button",
      "rmc-athletics-events-mens-basketball-button",
      "rmc-athletics-events-womens-basketball-button",
      "rmc-athletics-events-cheerleading-button",
      "rmc-athletics-events-cross-country-button",
      "rmc-athletics-events-football-button",
      "rmc-athletics-events-golf-button",
      "rmc-athletics-events-skiing-button",
      "rmc-athletics-events-mens-soccer-button",
      "rmc-athletics-events-womens-soccer-button",
      "rmc-athletics-events-track-button",
      "rmc-athletics-events-volleyball-button"
    ];
    ...
    $("#calendar-select-all").click(function() {
      ...
      console.log(desiredViews, allPossibleViews);
      desiredViews = allPossibleViews;
      calendar.rerenderEvents();

      sourceButtonsIDs.forEach(ii => {
        $("#" + ii).addClass("active");
      });
    });

    $("#calendar-deselect-all").click(function() {
    ...
    $("#rmc-athletics-events-cheerleading-button").click(function() {
      ...
      if (desiredViews.includes("rmc-athletics-cheerleading")) {
        desiredViews.splice(
          desiredViews.indexOf("rmc-athletics-cheerleading"),
          1
        );
        calendar.rerenderEvents();
      } else {
    ...
    $("#rmc-athletics-events-golf-button").click(function() {
      ...
      if (
        ...
        desiredViews.splice(desiredViews.indexOf("rmc-athletics-mens-golf"), 1);
        desiredViews.splice(
    ...
    $("#rmc-athletics-events-mens-soccer-button").click(function() {
      ...
      if (desiredViews.includes("rmc-athletics-mens-soccer")) {
        desiredViews.splice(
          desiredViews.indexOf("rmc-athletics-mens-soccer"),
          1
        );
        calendar.rerenderEvents();
      } else {
    ...
    $("#rmc-athletics-events-womens-soccer-button").click(function() {
      ...
      if (desiredViews.includes("rmc-athletics-womens-soccer")) {
        desiredViews.splice(
          desiredViews.indexOf("rmc-athletics-womens-soccer"),
          1
        );
        calendar.rerenderEvents();
      } else {
    ...
    $("#rmc-athletics-events-volleyball-button").click(function() {
      ...
      if (desiredViews.includes("rmc-athletics-volleyball")) {
        desiredViews.splice(
          desiredViews.indexOf("rmc-athletics-volleyball"),
          1
        );
        calendar.rerenderEvents();
      } else {
